...
def inputFolderPath = "/Volumes/Josh Video/Victor/Gallery/2.009 Gallery Builder/gallery-builder/";
//def outputFolderPath = "/Library/WebServer/Documents/gallery/"; // the actual live location where code should live
def outputFolderPath = "/Volumes/Josh Video/Victor/Gallery/2.009 Gallery Builder/gallery-builder/output/";
